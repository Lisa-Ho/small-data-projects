...
Another chart using the animal rescue incidents data for the #30DayChartChallenge (Day 3 - Circular). Full code [here](https://github.com/Lisa-Ho/small-data-projects/tree/main/2025/2504-lfb-animal-rescue-radar), interactive chart [here](https://inside-numbers.quarto.pub/london-animal-rescues/).
...
<img src="https://github.com/user-attachments/assets/51fdfa2a-b1a0-451f-9766-24a8e392dde0" width="550">
